	...
	public static void main(String[] args) {
		// 1. 시뮬레이션 기준 시간 (2026년 5월 1일 09:30)
				...
				if (t1 != null) {
					...
					System.out.println("💡 실제 발동 확인: 김철용(대기 40분)이 이급박(AQ)을 이기고 0순위로 나왔는가? 👉 " + t1.getMember().getName().equals("김철용"));
				}
				...
				if (t2 != null) {
					...
					System.out.println("💡 실제 발동 확인: 구민이 29분 진입으로 AQ 승격 후 최우선 호출되었는가? 👉 " + t2.getMember().getName().equals("구민"));
				}
