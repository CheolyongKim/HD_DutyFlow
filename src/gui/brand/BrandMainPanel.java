...
public class BrandMainPanel extends JPanel {
    ...
    public BrandMainPanel(ScreenManager screenManager) {
        ...
        JButton productListButton = new JButton("브랜드 상품 목록 조회");
        ...
        JButton orderHistoryButton = new JButton("브랜드 판매 내역 조회");
        JButton logoutButton = new JButton("로그아웃");

        stockButton.setFont(new Font("맑은 고딕", Font.PLAIN, 18));
        productListButton.setFont(new Font("맑은 고딕", Font.PLAIN, 18));
        ...
        orderHistoryButton.setFont(new Font("맑은 고딕", Font.PLAIN, 18));
        logoutButton.setFont(new Font("맑은 고딕", Font.PLAIN, 18));

        stockButton.addActionListener(e -> screenManager.show("BRAND_STOCK"));
        productListButton.addActionListener(e -> screenManager.show("BRAND_PRODUCT_LIST"));
        ...
        orderHistoryButton.addActionListener(e -> screenManager.show("BRAND_ORDER_HISTORY"));
        logoutButton.addActionListener(e -> screenManager.show("LOGIN_SELECT"));

        add(titleLabel);
        add(stockButton);
        add(productListButton);
