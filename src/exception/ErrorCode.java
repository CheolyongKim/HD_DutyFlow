...
public enum ErrorCode {
	...
	PAYMENT_FAILED("PAYMENT_FAILED", "주문 결제 실패"), INVALID_ORDER_STATE("INVALID_ORDER_STATE", "부적절한 단계입니다."),

	DENIED_PAY("DENIED_PAY", "결제 불가 상태"), DENIED_CANCLE("DENIED_CANCLE", "취소 불가 상태"),
