...
public class PaymentDAO {
    ...
    public int insertPendingPayment(PaymentDTO paymentDTO) {
        ...
        String sql = "INSERT INTO Payment "
        		+ "(paymentId, orderId, paymentMethod, paymentStatus, requestedAmount, cardNumberMask, requestedAt) "
                + "VALUES (?, ?, ?, ?, ?, ?, ?)";
        try (Connection conn = OracleConnection.getConnection();
        	...
        	pstmt.setBigDecimal(5, paymentDTO.getAmount());
        	pstmt.setString(6, paymentDTO.getCardNumberMask()); // 마스킹 처리된 카드번호 
